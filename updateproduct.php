...
<html lang="en">
  ...
  <body style="background-image:url('./upload/update.jpg'); z-index:0; background-size:cover; opacity:0.8;">
   <div class="container">
       <div class="row">
           <div class="col-md-2"></div>
           <div class="col-md-8 ">
           <h1 class="text-center">Product Info</h1>
           <form action="updateproductsave.php" method="POST">
  ...
  <div class="form-group">
    ...
    <input type="file" class="form-control" id="exampleFormControlInput1" name="purl" placeholder="something about product">
  </div>
