...
<html lang="en">
  ...
  <body style="background-image:url('./upload/deals.jpg'); z-index:0; background-size:cover; opacity:0.8;">
   <div class="cont ">
       <div class="center shadow p-3 mb-5 bg-white rounded mt-4">
       <form action="dealsave.php" method="POST" onsubmit="return valid()">
...
<p style="color:red;"><?php if(isset($_SESSION['err'])) echo $_SESSION['err'];
  ...
  <button type="submit" class="btn btn-primary" name="set">Set</button>
</form>
       </div>
   </div>
