...
#imp::-webkit-scrollbar
  ...
  <?php
   ...
   <h1 class="text-center my-5"><?php echo $_GET['cat'];?></h1>
...
<div class="row">
 ...
 <div class="card mb-5" style="width: 19rem; margin-left:15px; margin-right:15px; padding:10px">
 <!-- <h3 class="card-title text-center "><?php echo $rw[0];?></h3> -->
  ...
  <h6 class="card-title text-center text-muted"><?php echo $rw[0];?></h6>
    <h6 class="card-title text-center text-muted"><sup><i class="fas fa-rupee-sign"></sup></i> <span style="font-size:1.5rem;"> <?php echo $rw[1];?></span></h6>
