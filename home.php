...
#imp::-webkit-scrollbar
  ...
  <?php
   ...
   <!-- carousel -->
   <div id="carouselExampleCaptions" class="carousel slide carousel-fade " data-ride="carousel" style="z-index:0; opacity:0.9; height:300px">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./upload/carousal.jpg"
                    class="d-block w-100 h-70" alt="...">
                <div class="carousel-caption d-none d-md-block">
                   
                </div>
            </div>
            <div class="carousel-item">
                <img src="./upload/carousa.jpg"
                    class="d-block w-100 h-70" alt="...">
                <div class="carousel-caption d-none d-md-block">
...
<div class="row">
 ...
 <h3 class="card-title text-center" style="color:black;"><?php echo $rw[0];?></h3>
  ...
  <img src="https://unsplash.com/s/photos/<?php echo $rw[0];?>.png" class="card-img-top" height="200px"  alt="...">
...
<div class="container mt-5">
    <div class="row" id="imp" style="height:310px">
        <?php 
        $count=0;
